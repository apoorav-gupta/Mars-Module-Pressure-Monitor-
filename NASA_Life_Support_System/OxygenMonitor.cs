...
{
    public class OxygenMonitor : Monitor
    {
        ...
        private double min = 2.8, max = 3.9;
        Boolean mainSystem, targetSet, overRide;
        Boolean backupSystem;
        String backupSystemName = "Perchlorate System";
        String mainSystemName = "Electrolysis System";
        ...
        public String checkState()
        {
            ...
            else if ((averageValue >= (min-0.2) && averageValue < min) || (max > 3.9 && averageValue <= (max+0.2)))
            {
